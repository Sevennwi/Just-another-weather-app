...
function getCurrentWeather() {
  ...
  fetch(
    `https://api.openweathermap.org/data/3.0/onecall?lat=${userLat}&lon=${userLong}&exclude=hourly,minutely&appid=${APIKey}&units=metric&lang=fr`
  )
    .then((response) => response.json())
    .then((data) => {
      const userTemp = document.getElementById("userTemp");
      const userWindchillTempFr = document.getElementById(
        "userWindchillTempFr"
      );
      ...
      for (let i = 1; i < 6; i++) {
        ...
        forecastDate = new Intl.DateTimeFormat("fr-FR", {
          timeZone: currentTimeZone,
          weekday: "long",
          month: "long",
          day: "numeric",
      ...
      userWindchillTempFr.innerText =
        "Ressentie:" + " " + Math.trunc(data.current.feels_like) + "°C";
      ...
      if (data.current.rain) {
        userRainUv.innerHTML =
          '<span><i class="fa-solid fa-umbrella"></i></span>Pluie';
        ...
        userRainUv.innerHTML =
          '<span><i class="fa-solid fa-snowflake"></i></span>Neige';
        ...
        userRainUv.innerHTML =
          '<span><i class="fa-solid fa-umbrella-beach"></i></span>index UV';
          ...
          <div class="forecast-multiple-day-container">
            <div class="forecast-multiple-day-main">
              ...
              <div class="forecast-multiple-day-main-info">
                <div class="forecast-multiple-day-main-info_temp">
                  ...
                  <p>Ressentie:<br>${Math.trunc(day.feels_like.day)}°C</p>
                </div>
            ...
            <div class="forecast-multiple-day-second">
              <div class="forecast-multiple-day-second_div">
                ...
                <p class="forecast-multiple-day-second_div_feels">Ressentie ${Math.trunc(
                  day.feels_like.morn
                )}°C</p>
...
function getForecastWeather() {
  ...
  let userLong = localStorage.getItem("user-long");
  fetch(
    `https://api.openweathermap.org/data/2.5/forecast?lat=${userLat}&lon=${userLong}&appid=${APIKey}&units=metric&lang=fr`
  )
    .then((response) => response.json())
    .then((data) => {
      // Forecasts Same Day
